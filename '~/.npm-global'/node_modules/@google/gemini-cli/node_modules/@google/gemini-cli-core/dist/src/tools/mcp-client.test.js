...
import { populateMcpServerCommand, createTransport, isEnabled, discoverTools, discoverPrompts, hasValidTypes, connectToMcpServer, } from './mcp-client.js';
...
describe('mcp-client', () => {
    ...
    describe('connectToMcpServer', () => {
        it('should register a roots/list handler', async () => {
            ...
            await connectToMcpServer('test-server', {
                command: 'test-command',
            }, false, mockWorkspaceContext);
