...
class OTLPMetricExporterProxy extends otlp_grpc_exporter_base_1.OTLPGRPCExporterNodeBase {
    constructor(config) {
        ...
        super(config, signalSpecificMetadata, 'MetricsExportService', '/opentelemetry.proto.collector.metrics.v1.MetricsService/Export', otlp_transformer_1.ProtobufMetricsSerializer);
    }
